...
local BLOOD_COLOR_MATERIALS = {
	[BLOOD_COLOR_RED] = {
		...
		Absorption = Vector(0.05, 0.5, 0.5) * 128,
	...
	[BLOOD_COLOR_YELLOW] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(0.25, 0.3, 0.5) * 128,
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_GREEN] = {
		Roughness = 0,
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(0.3, 0.25, 0.5) * 128,
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_MECH] = {
		Roughness = 0,
	...
	[BLOOD_COLOR_ANTLION] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(0.4, 0.15, 0.5) * 128,
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_ZOMBIE] = {
		Roughness = 0,
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(0.2, 0.35, 0.5) * 128,
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_ANTLION_WORKER] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(0.45, 0.1, 0.5) * 128,
		DiffuseColor = Vector(0, 0, 0),
	},
}

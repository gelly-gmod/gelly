...
local BLOOD_COLOR_MATERIALS = {
	...
	[BLOOD_COLOR_GREEN] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(38.40, 32.00, 64.00),
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_MECH] = {
		Roughness = 0,
	...
	[BLOOD_COLOR_ANTLION] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(51.20, 19.20, 64.00),
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_ZOMBIE] = {
		Roughness = 0,
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(25.60, 44.80, 64.00),
		DiffuseColor = Vector(0, 0, 0),
	},
	[BLOOD_COLOR_ANTLION_WORKER] = {
		...
		IsSpecularTransmission = true,
		RefractiveIndex = 1.373,
		Absorption = Vector(57.60, 12.80, 64.00),
		DiffuseColor = Vector(0, 0, 0),
	},
}

 ...
 * This renderer will have some textures that we're going to try to share to the
 * D3D11 renderer.
 */
...
private:
	...
	struct {
		...
		IDirect3DTexture9 *input_depth;
		HANDLE *input_depth_shared_handle = nullptr;
	} gbuffer;
...
public:
	...
	[[nodiscard]] HANDLE *GetInputDepthSharedHandle();
};
